...
export const SYSTEM_INSTRUCTIONS = {
    ...
    MATCH_MAPPING_EXTRA_TIME: (match: string) => `Using the following match: ${match}, format your response as a JSON object with the following structure: { \"team1\": string, \"team2\": string, \"advances\": \"team1\" | \"team2\" }, where team1 and team2 are written exactly as seen in: ${ClubWorldCupTeams2025.join(', ')}. Every field is required. The advances field should be what the user specified in the query or which team has more goals.`,
